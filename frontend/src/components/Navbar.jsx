...
function linksParaPerfil(perfil) {
  if (perfil === "admin") return adminLinks;
  if (perfil === "ong") return ongLinks;
  return navLinks;
}
  ...
  return (
    <nav className="navbar-vb">
      ...
      <ul className="navbar-links">
        {linksParaPerfil(userData?.perfil).map((link) => (
          <li key={link.to}>
            <NavLink
              to={link.to}
              className={({ isActive }) =>
